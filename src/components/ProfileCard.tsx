...
function SocialItem(props: { data: string | null; social: string }) {
  ...
  const url = {
    location: `https://www.google.com/maps/place/${data}`,
    website: data as string,
    twitter: `https://twitter.com/${data}`,
    company: `https://github.com/${data?.replace('@', '')}`,
  }[social];
  ...
  return <p data-null='true'>Not Available</p>;
}
